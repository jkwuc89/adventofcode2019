...
describe DayTwo do
  ...
  describe '#run_program' do
    ...
    context 'with puzzle input' do
      ...
      it { expect(result[0]).to eq(4_138_687) }
    end
  end

  describe '#determine_noun_and_verb_for_output' do
  ...
  describe '#get_calculated_noun_and_verb_for' do
